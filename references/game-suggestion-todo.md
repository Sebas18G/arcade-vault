...
**Situación:** motor real en `components/games/invasores/` (`engine.ts`, `invasores-canvas.tsx`, `leaderboard.ts`) y tabla propia `invasores_scores`. Specs `specs/games-jam/14-invasores-motor.md` y `15-invasores-leaderboard.md` implementadas y mergeadas (PR #32). Skins `classic`/`retro`/`neon` implementadas por `skin-designer` en la corrida 5 (2026-09-05); su ficha vive en `references/skin-status.md`.
